...
Files: macbook-16.glb [639.28KB] > C:\Users\suryansh\Desktop\macbookdesign\public\models\macbook-16-transformed.glb [629.72KB] (1%)
  ...
  const texture = useTexture('./screen.png');
    ...
    useEffect(() => {
        scene.traverse((child) => {
            if(child.isMesh){
                // change color only if the part name is Not noChnageParts
